...
to [the napari hub customization guide](https://napari.org/stable/plugins/testing_and_publishing/hub_customization.html)
for detailed documentation on customizing your listing.
